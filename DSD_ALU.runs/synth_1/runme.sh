...
HD_PWD='C:/Users/lasit/DSD_ALU/DSD_ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_ALU.tcl
